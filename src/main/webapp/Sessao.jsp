...
<body class="forms">
	<div class="container">
			<form name="formCadastro" action="insertSessao" class="formulario2">
				...
				<div class="input-group">
					<div class="input-box">
						...
						<input id="nome" type="text" name="horario" placeholder="Digite o horario" required="required" >
					</div>
					...
					<div class="input-box">
						...
						<input id="data_sessao" type="date" name="data_sessao" placeholder="Data da sessão" required="required" >
					</div>
					...
					<div class="input-box">
						...
						<button onclick="window.location.href='admSessao'" id="voltar-sessao">Voltar</button>					
